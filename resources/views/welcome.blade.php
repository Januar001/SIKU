...
<head>
  ...
  <link href="{{ asset('/template') }}/assets/css/user-rtl.min.css" type="text/css" rel="stylesheet"
    id="user-style-rtl">
  <link href="{{ asset('/template') }}/assets/css/user.min.css" type="text/css" rel="stylesheet"
  ...
  <link href="{{ asset('/template') }}/vendors/leaflet/leaflet.css" rel="stylesheet">
  <link href="{{ asset('/template') }}/vendors/leaflet.markercluster/MarkerCluster.css" rel="stylesheet">
  <link href="{{ asset('/template') }}/vendors/leaflet.markercluster/MarkerCluster.Default.css" rel="stylesheet">
</head>
...
<body>
              ...
              <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home" role="button"
                ...
                <div class="parent-wrapper label-1">
                  <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                    ...
                    <li class="nav-item"><a class="nav-link" href="dashboard/travel-agency.html" data-bs-toggle=""
                        aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Travel agency</span><span
                            class="badge ms-2 badge badge-phoenix badge-phoenix-warning ">New</span></div>
                      </a><!-- more inner pages-->
                    </li>
        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
          ...
          <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button"
              ...
              <div class="avatar avatar-l ">
                <img class="rounded-circle " src="{{ asset('/template') }}/assets/img/team/40x40/57.webp" alt="" />
              </div>
            </a>
                  ...
                  <div class="scrollbar-overlay" style="height: 27rem;">
                    ...
                    <div class="px-2 px-sm-3 py-3 notification-card position-relative unread border-bottom">
                      <div class="d-flex align-items-center justify-content-between position-relative">
                        <div class="d-flex">
                          <div class="avatar avatar-m status-online me-3"><img class="rounded-circle"
                              src="{{ asset('/template') }}/assets/img/team/40x40/57.webp" alt="" /></div>
                          <div class="flex-1 me-sm-3">
          ...
          <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button"
            ...
            <ul class="dropdown-menu navbar-dropdown-caret">
              ...
              <li><a class="dropdown-item" href="dashboard/travel-agency.html">
                  <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="briefcase"></span>Travel
                    agency</div>
                </a></li>
          ...
          <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button"
            ...
            <ul class="dropdown-menu navbar-dropdown-caret">
              ...
              <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="travel-agency" href="#"
                  ...
                  <div class="dropdown-item-wrapper"><span
                      class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span class="me-2 uil"
                        data-feather="briefcase"></span>Travel agency</span></div>
                </a>
                <ul class="dropdown-menu">
  ...
  <script src="{{ asset('/template') }}/vendors/leaflet/leaflet.js"></script>
  <script src="{{ asset('/template') }}/vendors/leaflet.markercluster/leaflet.markercluster.js"></script>
  <script src="{{ asset('/template') }}/vendors/leaflet.tilelayer.colorfilter/leaflet-tilelayer-colorfilter.min.js">
  </script>
  <script src="{{ asset('/template') }}/assets/js/ecommerce-dashboard.js"></script>
</body>
